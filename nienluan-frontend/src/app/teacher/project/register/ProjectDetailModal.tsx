...
const ProjectDetailModal = ({ open, onClose, detail }: Props) => {
    ...
    return (
        ...
        >
            ...
            {detail.rejectNote && detail.rejectNote != null ? (
                <p><strong>Lý do từ chối:</strong> {detail.rejectNote}</p>
            ) : ''}
            ...
            <div>
                ...
                <ul style={{ marginTop: '0.1em' }} className="ml-4 list-disc">
