...
import UpdateUserStudentModal from '@/components/modal/userStudentProfile';
...
const rawMenuItems: MenuItem[] = [
    {
        ...
        children: [
            {
                key: 'student-project-register',
                label: <Link href="/student/project/register">Đề tài đăng ký</Link>,
                permission: 'access:thesis-register',
            },
            {
                key: 'student-publish-project',
                label: <Link href="/student/project/publish">Đề tài công bố</Link>,
    ...
    },
    {
        ...
        children: [
            {
                key: 'student-task',
                label: <Link href="/student/thesis/project">Công việc luận văn</Link>,
                permission: 'access:thesis-task',
            },
            {
                key: 'student-schedule',
                label: <Link href="/student/thesis/schedule">Lịch bảo vệ</Link>,
...
export default function MainLayout({ children }: { children: React.ReactNode }) {
    ...
    const [selectedMenu, setSelectedMenu] = useState<string>('Đề tài công bố');
            ...
            >
                ...
                <div style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 100px)' }}>
                    <Menu
                        theme="light"
                        mode="inline"
                        defaultSelectedKeys={['student-publish-project']}
                        onClick={handleClick}
